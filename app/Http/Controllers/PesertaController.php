...
class PesertaController extends Controller
{
    public function index(Request $request)
    {
        ...
        // Tambahkan orderBy berdasarkan status_ujian terlebih dahulu, lalu berdasarkan created_at
        $pesertas = $query->with('siswa', 'jenisUjian', 'programStudi')
                          ->orderBy('status_ujian', 'desc')  // Peserta yang sudah ujian berada di paling atas
