    ...
    public function ujian()
{
    ...
    // Ambil semua data ujian terkait peserta ini, termasuk nilai dan status ujian
    ...
    ->select('tb_peserta.*', 'tb_program_studi.nama_program_studi', 'tb_jenis_ujian.nama_ujian', 'tb_peserta.nilai as skor', 'tb_peserta.status_ujian') // Nilai diambil sebagai skor
    ->get();
