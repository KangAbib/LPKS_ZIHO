...
class ProgramPelatihanPageController
{
    ...
    {
        return view('admin.program-pelatihan-page.edit', compact('program_pelatihan_pages'));
    }
    ...
    public function destroy(ProgramPelatihan $program_pelatihan_pages)
    {
        ...
        return redirect()->route('program-pelatihan-page.index')->with('success', 'Halaman modern berhasil dihapus.');
    }
