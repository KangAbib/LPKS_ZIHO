  ...
  <div class="container">
    <div class="card shadow-sm">
      ...
      <div class="mb-3">
        ...
        <a href="{{ asset('laravel/storage/app/public/surat/' . $surat->file_surat) }}" class="btn btn-outline-primary"
    ...
    <div class="card shadow-sm mt-4">
      ...
      <iframe src="{{ asset('laravel/storage/app/public/surat/' . $surat->file_surat) }}" frameborder="0" width="100%" height="800"
