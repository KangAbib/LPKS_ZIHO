                ...
                <tr>
                    ...
                    <td>
                        @if ($pendaftaran->foto_ktp)
                            <img src="{{ asset('laravel/storage/app/public/upload-gambar' . $pendaftaran->foto_ktp) }}" alt="Foto KTP" width="50">
                        @endif
                    </td>
                    ...
                    <td>
                        @if ($pendaftaran->pas_foto)
                            <img src="{{ asset('laravel/storage/app/public/passfoto' . $pendaftaran->pas_foto) }}" alt="Pas Foto" width="50">
                        @endif
                    </td>
                    <td>
                        @if ($pendaftaran->foto_ijazah)
                            <img src="{{ asset('laravel/storage/app/public/ijazah' . $pendaftaran->foto_ijazah) }}" alt="Foto Ijazah" width="50">
                        @endif
                    </td>
                </tr>
            @endforeach
