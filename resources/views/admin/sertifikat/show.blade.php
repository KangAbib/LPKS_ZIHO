  ...
  <div class="container">
    <div class="card shadow-sm">
      ...
      <div class="mb-3">
        ...
        <a href="{{ asset('laravel/storage/app/public/sertifikat/' . $sertifikat->file_sertifikat) }}" class="btn btn-outline-primary"
    ...
    <div class="card shadow-sm mt-4">
      ...
      <iframe src="{{ asset('laravel/storage/app/public/sertifikat/' . $sertifikat->file_sertifikat) }}" frameborder="0" width="100%" height="800"
