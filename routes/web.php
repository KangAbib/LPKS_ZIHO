...
Route::group(['prefix' => 'admin', 'middleware' => 'admin'], function () {
    ...
    Route::get('/program-pelatihan-page/{program_pelatihan_pages}/edit', [ProgramPelatihanPageController::class, 'edit'])->name('admin.program-pelatihan-page.edit');
    Route::put('/program-pelatihan-page/{program_pelatihan_pages}', [ProgramPelatihanPageController::class, 'update'])->name('admin.program-pelatihan-page.update');
    Route::delete('/program-pelatihan-page/{program_pelatihan_pages}', [ProgramPelatihanPageController::class, 'destroy'])->name('admin.program-pelatihan-page.destroy');
...
// ------------------------------------------------
    // Dashboard user
    Route::get('/user/dashboard', [UserController::class, 'dashboard'])->name('user.dashboard_user');
